...
{
    Q_OBJECT
    Q_PROPERTY(int filterRowStart READ filterRowStart WRITE setFilterRowStart NOTIFY filterRowStartChanged)
    Q_PROPERTY(int filterRowEnd READ filterRowEnd WRITE setFilterRowEnd NOTIFY filterRowEndChanged)
...
public:
    ...
    void setFilterRowStart(int filterRowStart);
    int filterRowStart() const;
    Q_SIGNAL void filterRowStartChanged();

    void setFilterRowEnd(int filterRowEnd);
    int filterRowEnd() const;
    Q_SIGNAL void filterRowEndChanged();
